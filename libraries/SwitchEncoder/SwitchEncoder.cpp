...
void SwitchEncoder::resetCount()
{
	_count = 0;
}

/**
	Sets the counter to a certain value
*/

void SwitchEncoder::setCount(int c)
{
	_count = c;
}

/**
	Checks button state of the encoder
*/

int SwitchEncoder::button()
{
